...
class Image:
    ...
    def scale_image(self, scaleFactor):
        ...
        self.img_object = cv2.resize(self.img_object, new_dimensions,
    ...
    def calculate_all_threshold_positions(self, threshold, size, color):
        ...
        if Config.SINGLE_COLOR_SELECTION:
            ...
            mask = cv2.inRange(self.img_object, (255, 255, 255), (255, 255, 255))
        ...
        for x in range(sub_wid - 1):
            ...
            for y in range(sub_len - 1):
                # Check if passes threshold occurrences of color in sub matrix
            ...
            if y_positions:
                ...
                self.column_positions.update({x * size: y_positions})
